        ...
        do {
            ...
            if (scan.hasNextInt()) {
                ...
                if (inputNumber == randomNumber) {
                    ...
                    System.out.println(ANSI_PURPLE + "\nPlayer! The secret number is little smaller!\n" + ANSI_RESET);
                    lastTwoPastTips.add(pastTips.get(pastTips.size() - 1));
                    lastTwoPastTips.add(1);
                    return lastTwoPastTips;

                } else if (inputNumber > (randomNumber * 0.8) && inputNumber < randomNumber) {
                    System.out.println(ANSI_PURPLE + "\nPlayer! The secret number is little larger!\n" + ANSI_RESET);
                    lastTwoPastTips.add(pastTips.get(pastTips.size() - 1));
                    lastTwoPastTips.add(2);
                    return lastTwoPastTips;

                } else if (inputNumber > randomNumber) {
                    System.out.println(ANSI_PURPLE + "\nPlayer! The secret number is way smaller!\n" + ANSI_RESET);
                    lastTwoPastTips.add(pastTips.get(pastTips.size() - 1));
                    lastTwoPastTips.add(3);
                    return lastTwoPastTips;

                } else if (inputNumber < randomNumber) {
                    System.out.println(ANSI_PURPLE + "\nPlayer! The secret number is way larger!\n" + ANSI_RESET);
                    lastTwoPastTips.add(pastTips.get(pastTips.size() - 1));
